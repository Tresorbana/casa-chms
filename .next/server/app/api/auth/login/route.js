...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   prisma: () => (/* binding */ prisma)\n/* harmony export */ });\n/* harmony import */ var _prisma_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @prisma/client */ \"@prisma/client\");\n/* harmony import */ var _prisma_client__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_prisma_client__WEBPACK_IMPORTED_MODULE_0__);\n\nconst prismaClientSingleton = ()=>{\n    return new _prisma_client__WEBPACK_IMPORTED_MODULE_0__.PrismaClient().$extends({\n        query: {\n            $allModels: {\n                async $allOperations ({ model, operation, args, query }) {\n                    const maxRetries = 3;\n                    let retries = 0;\n                    while(retries < maxRetries){\n                        try {\n                            return await query(args);\n                        } catch (error) {\n                            // Retry on connection errors (like P1001 or timeout)\n                            if (error?.message?.includes(\"Can't reach database server\") || error?.message?.includes('timeout') || error?.code === 'P1001') {\n                                retries++;\n                                console.warn(`[Neon Cold Start] Database connection failed. Retrying... (${retries}/${maxRetries})`);\n                                // Exponential backoff: 1s, 2s, 4s\n                                await new Promise((res)=>setTimeout(res, 1000 * Math.pow(2, retries - 1)));\n                            } else {\n                                throw error;\n                            }\n                        }\n                    }\n                    // If we reach here, it failed after all retries\n                    return query(args);\n                }\n            }\n        }\n    });\n};\nconst globalForPrisma = globalThis;\nconst prisma = globalForPrisma.prisma ?? prismaClientSingleton();\nif (true) globalForPrisma.prisma = prisma;\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./src/lib/db.ts\n");
