...
export const HOTEL_INFO = {
  ...
  email: 'reception@kamdinehotel.rw',
  description:
    'Well-maintained rooms, an on-site restaurant, and a highly-rated outdoor view — known for beautiful exterior views and a relaxing lake getaway.',
  amenities: [
