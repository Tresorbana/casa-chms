    ...
    <div className="min-h-screen bg-background p-4 lg:p-8 flex flex-col gap-6">
      ...
      <div className="max-w-3xl mx-auto w-full space-y-5">
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-sm text-muted-foreground mt-0.5">{user.role} · Casa Hotel</p>
        ...
        <div className="text-center py-4 border-t border-border">
          <p className="text-[11px] text-muted-foreground">Casa Hotel Management System · Version 3.0</p>
        </div>
      </div>
    </div>
  );
