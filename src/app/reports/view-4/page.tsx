...
export default function Reports4() {
  return (
    <div className="flex-1 min-h-screen relative">
      

<main className="lg:ml-64 min-h-screen ml-64">
<div className="flex gap-2 mb-6 overflow-x-auto pb-2 border-b border-slate-100 dark:border-slate-800 p-6"><span className="text-xs font-semibold text-slate-400 uppercase tracking-wider self-center mr-2">Views:</span><a className="px-3 py-1.5 text-xs font-medium rounded-lg transition-all whitespace-nowrap bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700" href="/reports">View 1</a><a className="px-3 py-1.5 text-xs font-medium rounded-lg transition-all whitespace-nowrap bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700" href="/reports/view-2">View 2</a><a className="px-3 py-1.5 text-xs font-medium rounded-lg transition-all whitespace-nowrap bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700" href="/reports/view-3">View 3</a><a className="px-3 py-1.5 text-xs font-medium rounded-lg transition-all whitespace-nowrap bg-primary text-white shadow-sm" href="/reports/view-4">View 4</a></div><header className="glass-header px-8 py-4">
...
<button className="px-4 py-2 text-xs font-bold hover:bg-white dark:hover:bg-slate-700 rounded-r-lg transition-colors">Staff Performance</button>
</div>
<div className="flex items-center gap-2 pl-3 border-l border-slate-200 dark:border-slate-700">
<div className="flex items-center gap-2">
<button className="bg-excel hover:bg-emerald-800 text-white px-4 py-2.5 rounded-xl font-bold text-sm shadow-lg shadow-emerald-900/10 flex items-center gap-2 transition-all group">
<span className="material-symbols-outlined text-lg">grid_on</span>
<span>Export to Excel (.xlsx)</span>
</button>
<button className="bg-primary hover:bg-green-800 text-white px-4 py-2.5 rounded-xl font-bold text-sm shadow-lg shadow-primary/20 flex items-center gap-2 transition-all">
...
<p className="text-xs text-slate-400">Monthly breakdown for the current fiscal year (Spreadsheet Ready)</p>
</div>
...
<p className="text-xs text-slate-400">By Service Category (Exportable)</p>
</div>
...
<p className="text-xs text-slate-400 mt-1">Granular reporting. All filtered data is included in the (.xlsx) export.</p>
</div>
...
<tfoot className="border-t-2 border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/80 font-bold">
<tr>
<td className="px-8 py-5 text-xs text-slate-400 uppercase tracking-widest">Total Summary</td>
<td className="px-8 py-5"></td>
<td className="px-8 py-5"></td>
<td className="px-8 py-5 text-xs text-slate-500 text-right uppercase">Calculated Yield:</td>
<td className="px-8 py-5 text-base font-black text-right text-primary">$1,720.00</td>
<td className="px-8 py-5 text-center">
<span className="inline-flex items-center gap-1 text-[10px] text-excel bg-excel/10 px-2 py-0.5 rounded-md uppercase">Excel Verified</span>
</td>
</tr>
</tfoot>
</table>
